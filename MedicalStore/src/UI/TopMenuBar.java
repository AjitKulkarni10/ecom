...
public class TopMenuBar extends JMenuBar {
	...
	public TopMenuBar(Frame parentFrame) {
		 ...
		 * updateInventory.addActionListener(new ActionListener() { public void
		 * actionPerformed(ActionEvent ae) { addAnotherPanel(parentFrame, new
		 * UpdateInventory(parentFrame)); } });
		 */
		 ...
		 * service.add(retailerDetail); retailerDetail.addActionListener(new
		...
		styleMenuItems(addMedicine, medicineList, searchMedicine,
	addSupplier, searchSupplier,
	checkoutMedicine, monthlyBuyingReport, monthlySoldReport, dashboard);
